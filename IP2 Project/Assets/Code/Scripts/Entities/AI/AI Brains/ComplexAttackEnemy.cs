...
public class ComplexAttackEnemy : MonoBehaviour, IEntityBrain
{
    ...
    private void Awake()
    {
        ...
        _attackingState.InitialiseValues(_movementScript, _rotationPivot, () => _entitySenses.CurrentTarget.position);
